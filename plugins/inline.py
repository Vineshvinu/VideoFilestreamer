...
buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/THM_OTT"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/Tamil_Hackers_Moviess"),
            ],
            [
                InlineKeyboardButton("Let's Go.....", url="https://t.me/THM_OTT"),
            ]
         ]
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultArticle(
                title="**🔒This is closed Repository project by VINU🔒**",
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@THM_OTT | @THM_OTT 👑</b>", disable_web_page_preview=True),
